...
const T = {
  ...
  chart_note_heat: { en: "Brighter gold means closer to 1,000 that day.", ur: "زیادہ چمکیلا سنہری مطلب اس دن 1,000 کے قریب۔" },
  chart_note_year: { en: "Each bar: days you reached 1,000 that month.", ur: "ہر ستون: اس مہینے 1,000 مکمل کرنے کے دن۔" },
  range_week: { en: "Week", ur: "ہفتہ" },
  range_month: { en: "Month", ur: "مہینہ" },
  range_quarter: { en: "Quarter", ur: "سہ ماہی" },
  range_year: { en: "Year", ur: "سال" },
